...
// Transportniy_potok.cpp : Определяет поведение классов для приложения.
//
...
// CTransportniy_potokApp

BEGIN_MESSAGE_MAP(CTransportniy_potokApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTransportniy_potokApp

CTransportniy_potokApp::CTransportniy_potokApp()
{
...
// Единственный объект CTransportniy_potokApp

CTransportniy_potokApp theApp;


// инициализация CTransportniy_potokApp

BOOL CTransportniy_potokApp::InitInstance()
{
